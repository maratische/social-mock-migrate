...
import com.examples.uidcreator.controller.JXUtil
...
class UidCreatorService {
    ...
    @GetMapping()
    @ResponseBody
    fun getAuthForm(@RequestParam("data") data: String) = Mono.fromCallable(Callable<ResponseHttpUidRequest> {
...
//        threads.forEach(Thread::join)
        ...
        ResponseHttpUidRequest(uid, false, false)
    })
