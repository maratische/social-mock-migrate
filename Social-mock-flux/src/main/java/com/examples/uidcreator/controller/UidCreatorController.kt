...
class UidCreatorController(var uidCreatorService: UidCreatorService) {
    ...
    @GetMapping("key")
    @ResponseBody
    fun privateKey(@RequestParam("privateKey") privateKey: String): String = uidCreatorService.privateKey(privateKey)
...
data class ExternalHttpUidRequest @JsonCreator constructor(
    @JsonProperty("reason") val reason: ExternalHttpUidRequestReason,
...
data class SocialLinkingUIdRequest @JsonCreator constructor(
    @JsonProperty("type") val type: String,
    @JsonProperty("id") val id: String
) {
}

data class ResponseHttpUidRequest @JsonCreator constructor(
